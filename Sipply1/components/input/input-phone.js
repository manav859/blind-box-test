    ...
    class ThemeInputPhone extends BaseElement {
        ...
        constructor() {
            ...
            if (this.#countrySelectElement) {
                ...
                const currentCountryElement = this.#countrySelectElement.querySelector('option[selected="selected"]');
                if (currentCountryElement) {
                    ...
                    const firstCountryElement = this.#countrySelectElement.querySelector('option');
                    this.#countrySelectElement.value = firstCountryElement.value;
                    labelElement.innerText = `+${firstCountryElement.value}`;
                }
            }
        }
    }
